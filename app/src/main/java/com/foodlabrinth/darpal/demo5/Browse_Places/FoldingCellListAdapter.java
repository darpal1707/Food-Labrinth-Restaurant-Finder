...
public class FoldingCellListAdapter extends ArrayAdapter<Item> {
    ...
    BrowsePlacesActivity mainActivity;
    ...
    public FoldingCellListAdapter(Context context, ArrayList<Item> objects, String rate) {
        super(context, 0, objects);
        this.context = context;
        this.mainActivity = (BrowsePlacesActivity) context;
        context1 = context;
        this.rate11 = rate;
        Log.e("bowse adapter", String.valueOf(objects));
    }
            ...
            public void onClick(View v) {
                try {
                    if (uid.equals("")) {
                        ...
                        try {
                            upLoadServerUri = "http://foodlabrinth.com/bookmark_res.php?Bookmark_Status=" + status + "&Res_id=" + item.getResid() + "&Uid=" + uid;
